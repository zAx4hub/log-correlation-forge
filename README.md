# Log Correlation Forge

> Forge correlation IDs that survive hops

**Author:** zAx4hub

## Problem

Forge correlation IDs that survive hops. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`log-correlation-forge` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **crdt** engine, CLI, examples, and tests.
...
1. Core crdt engine tailored to the problem
